...
import useSwitchConsumptionCalculation from "../../hooks/useSwitchConsumptionCalculation";
...
const SwitchTariffComparisionCard = ({
  tariff,
  consumptionData,
  fromDate,
  toDate,
  ...
  setCost,
  rank,
}: ISwitchTariffComparisionCard) => {
  const { cost, totalStandingCharge, totalPrice, totalUnit, isLoading, error } =
    useSwitchConsumptionCalculation({
      tariff,
      fromDate,
      toDate,
      type,
...
export default memo(SwitchTariffComparisionCard);

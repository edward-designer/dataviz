...
export const metadata: Metadata = {
  title: "Octopus Agile Plan Unit Rates for Today and Tomorrow | Octoprice",
  description:
  ...
  openGraph: {
    title: "Octopus Agile Plan Unit Rates for Today and Tomorrow | Octoprice",
    description:
      "Get the latest unit rates for gas and electicity on the Octopus Agile Plan, with graphs showing the price trends and price differences all over UK.",

...
const About = () => {
  return (
    <div className="lg:col-[content] my-4 flex flex-col gap-6">
      <p className=" text-accentBlue-600 text-5xl">Hello Octopus!</p>
      ...
      <p>
        ...
        savings Octopus is bringing. I keep thinking is there anything I can
        make it any better with my skillsets.
      </p>
      <p>
        The Octoprice app is my two cents to help dear Octopus users like me who
        would want an easier and visually more pleasant way to get the latest
        unit rates to plan ahead for our energy uses for greater savings on
        energy costs.
      </p>
      ...
      <p>
        ...
        responsibility for your actions based on the information here.
      </p>
      <p>

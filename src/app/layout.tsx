      ...
      <html lang="en">
        ...
        >
          <Toast>
            ...
            <div className="min-h-screen p-4 lg:grid grid-rows-[100px_1fr] lg:py-0 lg:p-0 lg:grid-cols-[[fullwidth_start]_minmax(0,5%)_[breakout_start]_minmax(0,5%)_[content_start]_minmax(1000px,_1fr)_[content_end]_minmax(0,5%)_[breakout_end]_minmax(0,5%)_[fullwidth_end]]">
